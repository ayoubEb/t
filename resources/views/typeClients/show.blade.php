      ...
      <table class="table table-bordered m-0 info">
        <tbody>
          ...
          <tr>
            ...
            <td class="align-middme">
              {!! $typeClient->statut == 1 ? '<span class="text-success mdi mdi-check-bold mdi-18px"></span>' : '<span class="text-danger mdi mdi-close-thick mdi-18px"></span>'  !!}
            </td>
          </tr>
        </tbody>
      </table>
